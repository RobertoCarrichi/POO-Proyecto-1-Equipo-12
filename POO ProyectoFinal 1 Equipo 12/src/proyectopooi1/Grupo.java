...
public class Grupo {
    ...
    // Colección que almacenará el grupo como clave y lista de alumnos como valor
    ...
    void abrirGrupo(ArrayList<Profesor> profesores, ArrayList<Asignatura> materias){
        ...
        System.out.println("\n\t¡ATENCIÓN! Deberás elegir un profesor y una asignatura para poder abri un grupo.\n");
        ...
        do{
            ...
            System.out.println("Has elegido: " + seleccionA.nombre + "\n");
            else {
        ...
        Profesor seleccionP; // Seleccion de Profesor
        do{
    ...
    void listaProfesores(ArrayList<Profesor> profesores){
        if(profesores.size()==0){
            System.out.println("¡VAYA! No hemos encontrado profesores registrados.");
            System.out.println("¿Quieres registrar uno?");
        }
    ...
    void listaAsignaturas(ArrayList<Asignatura> materias){
        if(materias.size()==0){
            System.out.println("¡CHISPAS! No hemos encontrado asignaturas registradas con anterioridad.");
        }
