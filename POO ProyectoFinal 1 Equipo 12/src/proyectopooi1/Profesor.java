...
public class Profesor {
    ...
    public Profesor(String nombre, String titulo, int anios, String egreso){
        this.nombre = nombre;
        this.titulo = titulo;
        this.anios = anios;
        this.institucionEgreso = egreso;
        
        // El contador global de profesores registrados aumenta
        totalProfesores += 1;
    }
    ...
    void registrarProfesor(){
        ...
        for(int i = 0; i < cant; i++){
            ...
            System.out.print("Institución de procedencia: ");
            ...
            Profesor aux = new Profesor(xnombre, xtitulo, xanios, egreso);
    ...
    void info(){
        ...
        System.out.println("Institucion de egreso: " + this.institucionEgreso);
    ...
    void mostrarProfesores(){
        if(maestros.size()==0){
            System.out.println("Lo sentimos, no hay profesores registrados.\n");
        }else{
            System.out.println("Datos de los profesores\n");
        
            // "maestro" hace referencia a UNO de lo elementos de la coleccion "maestros".  
            for(Profesor maestro: maestros){
                maestro.info();
                System.out.println();
            }
