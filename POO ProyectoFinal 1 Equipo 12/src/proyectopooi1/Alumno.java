...
public class Alumno {
    ...
    // Colección de objetos de esta clase.
    ArrayList<Alumno> alumnitos = new ArrayList<>();
    
    // CONSTUCTORES
    public Alumno(){}
    
    public Alumno(String nombre, String apellidos, int cuenta, String semestre){
        this.nombre = nombre;
        this.apellidos = apellidos;
        this.cuenta = cuenta;
        this.semestre = semestre;
        
        // Aumenta 1 por cada instancia de la clase que se agregue
        totalAlumnos += 1;
    }
    ...
    void registrarAlumno(){
        ...
        for(int i = 0; i < agregar; i++){
            ...
            Alumno aux = new Alumno(xnombre, xapellidos, xcuenta, xsemestre);
    ...
    void info(){
        System.out.println("Nombre(s): " + this.nombre);
